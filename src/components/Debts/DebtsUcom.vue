      ...
      <div class="d-flex h-full w-full">
        <div class="w-full">
          <div class="grid mb-8">
            ...
            <div></div>
            <div></div>
            <common-clients-data-head>Հերթական համար</common-clients-data-head>
            <common-clients-data-head>Հիմնական պարտք</common-clients-data-head>
            <common-clients-data-head>ID</common-clients-data-head>
            <common-clients-data-head>Account</common-clients-data-head>
