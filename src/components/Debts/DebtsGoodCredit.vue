      ...
      <div class="d-flex h-full w-full">
        <div class="w-full">
          <div class="grid mb-8">
            ...
            <div></div>
            <div></div>
            <common-clients-data-head>Պայմանագիր</common-clients-data-head>
            <common-clients-data-head>Անվանում</common-clients-data-head>
            <common-clients-data-head>Արժ</common-clients-data-head>
            <common-clients-data-head>Total DEbt</common-clients-data-head>
            <common-clients-data-head>Գումար</common-clients-data-head>
          </div>
