  ...
  <div class="d-flex justify-content-center">
    <div class="w-full max-w-36">
      <common-select
        ...
        :Datavalue="$store.getters.Partners"
        :Size="'max-h-26 max-w-36'"
      ...
      <common-select
        ...
        :Datavalue="$store.getters.Statuses"
        :value="'Կարգավիճակ'"
        :Size="'max-h-34 max-w-36'"
        :padding="'pb-3 ps-7'"
        :img="'bg-36'"
      ></common-select>
      <common-input
      ...
      ></common-input>
      <common-button class="py-5 mt-10">
        <div class="d-flex">
          <div class="bg-35 bg-no-repeat w-11 h-11 bg-contain me-6"></div>
          <span>Փնտրել</span>
        </div>
      </common-button>
    </div>
